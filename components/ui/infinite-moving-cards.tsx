  ...
  return (
    ...
    >
      ...
      >
        {items.map((item, idx) => (
          <li
            className="w-[350px] max-w-full relative rounded-2xl border border-b-0 flex-shrink-0 border-primary px-8 py-6 md:w-[450px]"
            style={{
              background: "linear-gradient(to bottom, #0F0F1A, #18172C)",
            }}
            key={item.name}
          >
            <blockquote>
