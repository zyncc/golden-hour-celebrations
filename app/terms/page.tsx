...
const Page = () => {
  return (
    <div className={"container mx-auto my-[100px] text-justify"}>
      <h1 className={"text-center font-bold text-3xl"}>Terms and Conditions</h1>
      <ol type={"A"} className={"list flex flex-col gap-y-3 mt-5"}>
        <li>
          <p>
        ...
        <li>
          <p>
            ...
            https://goldenhourcelebrations.in/ , including the related mobile
            site and mobile application.
          </p>
        </li>
        <li>
          <p>
            The Platform is owned by Golden Hour Celebrations, a company
            incorporated under the Companies Act, 1956 with its registered
            office at 1st Floor, Right, 29th Cross Rd, near Cool Joint, behind
            Shree Sagar Restaurant, Geetha Colony, 4th T Block East, 4th Block,
            Jayanagar, Bengaluru ,Bangalore ,India (hereinafter referred to as
        ...
        <li>
          <p>
            ...
            (collectively, &#39;Services&#39;). Any terms and conditions
        ...
        <li>
          <p>
            ...
            requires &#39;you&#39;, &#39;your&#39; or &#39;user&#39; shall mean
      ...
      <ol type={"I"} className={"list2 flex flex-col gap-y-3 px-5 mt-3"}>
        <li>
          <p>
        ...
        <li>
          <p className="font-bold">
            Golden Hour Celebrations belongs to Tanushree Krishna
          </p>
        </li>
      </ol>
    </div>
