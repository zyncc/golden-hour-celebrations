...
export const InfiniteMovingCards = ({
  ...
  return (
    <div
      ref={containerRef}
      className={cn(
        "scroller relative z-20 h-fit max-w-7xl overflow-hidden mask-[linear-gradient(to_right,transparent,white_20%,white_80%,transparent)]",
        className,
      )}
    >
      <ul
        ...
        {items.map((item, idx) => (
          ...
          >
            <blockquote>
              ...
              ></div>
              <span className="text-foreground relative z-20 flex text-sm leading-[1.6] font-normal">
                {item.name}
              </span>
              <div className="relative z-20 mt-6 flex flex-row items-center">
                <span className="flex flex-col gap-1">
                  <span className="text-sm leading-[1.6] font-normal italic">
                    &quot;{item.description}&quot;
                  </span>
                </span>
              </div>
